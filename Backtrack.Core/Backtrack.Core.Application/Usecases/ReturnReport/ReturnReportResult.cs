...
public static class C2CReturnReportResultMapper
{
    public static C2CReturnReportResult ToC2CReturnReportResult(this C2CReturnReport report) => new()
    {
        ...
        FinderPost      = report.FinderPost.ToPostResult(isBlur: report.FinderPost.Category == ItemCategory.Cards),
        OwnerPost       = report.OwnerPost.ToPostResult(isBlur: report.OwnerPost.Category == ItemCategory.Cards),
