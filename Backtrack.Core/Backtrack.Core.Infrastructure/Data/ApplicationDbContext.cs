...
namespace Backtrack.Core.Infrastructure.Data
{
    public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : DbContext(options)
    {
        ...
        public DbSet<OrgFormTemplate> OrgFormTemplates { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new HandoverConfiguration());
            modelBuilder.ApplyConfiguration(new P2PHandoverConfiguration());
            modelBuilder.ApplyConfiguration(new OrgHandoverConfiguration());
            modelBuilder.ApplyConfiguration(new OrgFormTemplateConfiguration());
        }
    }
}