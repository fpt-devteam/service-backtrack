...
namespace Backtrack.Core.Infrastructure.Migrations
{
    ...
    [Migration("20260530083125_AddClaimRequestIdToOrgReturnReport")]
    partial class AddClaimRequestIdToOrgReturnReport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backtrack.Core.Domain.Entities.Answer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Backtrack.Core.Domain.Entities.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Backtrack.Core.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SourceName", "SourceEventId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Backtrack.Core.Domain.Entities.PostMatch", b =>
                {
                    ...
                    b.HasIndex("LostPostId", "FoundPostId")
                        .IsUnique()
                        .HasDatabaseName("ix_post_matches_lost_found")
                        .HasFilter("deleted_at IS NULL");

                    b.HasIndex("FoundPostId", "Status", "Score")
                        .HasDatabaseName("ix_post_matches_by_found");

                    b.HasIndex("LostPostId", "Status", "Score")
            ...
            modelBuilder.Entity("Backtrack.Core.Domain.Entities.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Backtrack.Core.Domain.Entities.Answer", b =>
                {
                    ...
                    b.HasOne("Backtrack.Core.Domain.Entities.Question", "Question")
                        .WithMany("Answers")
